...
const ProjectDetail = () => {
  ...
  const projects = {
    'haznedar-park': {
      ...
      images: [
        '/src/assets/haznedar_park/26.jpg',
        '/src/assets/haznedar_park/2.jpg',
        '/src/assets/haznedar_park/3.jpg',
        '/src/assets/haznedar_park/4.jpg',
        '/src/assets/haznedar_park/6.jpg',
        '/src/assets/haznedar_park/9.jpg',
        '/src/assets/haznedar_park/10.jpg',
        '/src/assets/haznedar_park/11.jpg',
        '/src/assets/haznedar_park/12.jpg',
        '/src/assets/haznedar_park/13.jpg',
        '/src/assets/haznedar_park/14.jpg',
        '/src/assets/haznedar_park/15.jpg',
        '/src/assets/haznedar_park/19.jpg',
        '/src/assets/haznedar_park/20.jpg',
        '/src/assets/haznedar_park/23.jpg',
        '/src/assets/haznedar_park/24.jpg',
        '/src/assets/haznedar_park/25.jpg',
        '/src/assets/haznedar_park/27.jpg',
        '/src/assets/haznedar_park/29.jpg',
        '/src/assets/haznedar_park/30.jpg',
        '/src/assets/haznedar_park/31.jpg',
        '/src/assets/haznedar_park/32.jpg',
        '/src/assets/haznedar_park/33.jpg'
      ]
    },
    'bagcilar-meydan-life': {
      ...
      images: [
        '/src/assets/bagcilar_meydan_life/a7-min.png',
        '/src/assets/bagcilar_meydan_life/a1-min.png',
        '/src/assets/bagcilar_meydan_life/a2-min.png',
        '/src/assets/bagcilar_meydan_life/a3-min.png',
        '/src/assets/bagcilar_meydan_life/a4-min.png',
        '/src/assets/bagcilar_meydan_life/a5-min.png',
        '/src/assets/bagcilar_meydan_life/a6-min.png',
        '/src/assets/bagcilar_meydan_life/a8-min.png',
        '/src/assets/bagcilar_meydan_life/a9-min.png',
        '/src/assets/bagcilar_meydan_life/a10-min.png',
        '/src/assets/bagcilar_meydan_life/a11-min.png',
        '/src/assets/bagcilar_meydan_life/a12-min.png',
        '/src/assets/bagcilar_meydan_life/a13-min.png',
        '/src/assets/bagcilar_meydan_life/a14-min.png',
        '/src/assets/bagcilar_meydan_life/a16-min.png',
        '/src/assets/bagcilar_meydan_life/a17-min.png',
        '/src/assets/bagcilar_meydan_life/a18-min.png',
        '/src/assets/bagcilar_meydan_life/a19-min.png',
        '/src/assets/bagcilar_meydan_life/a20-min.png',
        '/src/assets/bagcilar_meydan_life/b1-min.png',
        '/src/assets/bagcilar_meydan_life/b2-min.png'
      ]
    },
    'fatih-gulbahce-konagi': {
      ...
      images: [
        '/src/assets/fatih_gulbahce_konagi/12.jpg',
        '/src/assets/fatih_gulbahce_konagi/1.jpg',
        '/src/assets/fatih_gulbahce_konagi/2.jpg',
        '/src/assets/fatih_gulbahce_konagi/3.jpg',
        '/src/assets/fatih_gulbahce_konagi/4.jpg',
        '/src/assets/fatih_gulbahce_konagi/5.jpg',
        '/src/assets/fatih_gulbahce_konagi/6.jpg',
        '/src/assets/fatih_gulbahce_konagi/7.jpg',
        '/src/assets/fatih_gulbahce_konagi/8.jpg',
        '/src/assets/fatih_gulbahce_konagi/9.jpg',
        '/src/assets/fatih_gulbahce_konagi/10.jpg',
        '/src/assets/fatih_gulbahce_konagi/11.jpg',
        '/src/assets/fatih_gulbahce_konagi/13.jpg',
        '/src/assets/fatih_gulbahce_konagi/14.jpg',
        '/src/assets/fatih_gulbahce_konagi/15.jpg',
        '/src/assets/fatih_gulbahce_konagi/16.jpg',
        '/src/assets/fatih_gulbahce_konagi/17.jpg',
        '/src/assets/fatih_gulbahce_konagi/18.jpg',
        '/src/assets/fatih_gulbahce_konagi/19.jpg',
        '/src/assets/fatih_gulbahce_konagi/20.jpg',
        '/src/assets/fatih_gulbahce_konagi/21.jpg',
        '/src/assets/fatih_gulbahce_konagi/22.jpg',
        '/src/assets/fatih_gulbahce_konagi/23.jpg',
        '/src/assets/fatih_gulbahce_konagi/24.jpg',
        '/src/assets/fatih_gulbahce_konagi/25.jpg',
        '/src/assets/fatih_gulbahce_konagi/26.jpg',
        '/src/assets/fatih_gulbahce_konagi/27.jpg',
        '/src/assets/fatih_gulbahce_konagi/28.jpg',
        '/src/assets/fatih_gulbahce_konagi/29.jpg',
        '/src/assets/fatih_gulbahce_konagi/30.jpg'
      ]
    }
  };
